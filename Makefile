...
recursive_stack.o: recursive_stack.vhdl
	ghdl -a --ieee=synopsys recursive_stack.vhdl
pw_string.o: pw_string.vhdl
	ghdl -a --ieee=synopsys pw_string.vhdl
...
testbench_pw_string.o: testbench_pw_string.o pw_string.o
	ghdl -a --ieee=synopsys testbench_pw_string.vhdl
